!function () {
    ...
    function () {
        ...
        function t(t, e) {
            ...
            o.map((function (t) {
                    return t.functionName && (t.functionName = (e = t.functionName, n = e.split("/"), e = (e = (e = n.length > 1 ? ["Object", n[n.length - 1]].join(".") : n[0]).replace(/.<$/gi, ".<anonymous>")).replace(/^Anonymous function$/, "<anonymous>"), e = (n = e.split(".")).length > 1 ? n[n.length - 1] : n[0])),
                    t;
                    var e,
                    n
                })).map((function (t) {
        ...
        try {
            ...
            if (e && ("object" == typeof e || "function" == typeof e)) {
                ...
                if ("function" == typeof n)
                    return void l((r = n, i = e, function () {
                            r.apply(i, arguments)
                        }), t)
            }
            t._state = 1,
    ...
    var p = o,
    v = {};
    m ? v = window : "undefined" != typeof self && (v = self);
    var h = "Promise" in v ? v.Promise : p,
    g = [].slice,
    m = "undefined" != typeof window,
    y = m && "undefined" != typeof performance ? performance : {};
    for (var S = [], _ = 0; _ < 256; ++_)
        S[_] = (_ + 256).toString(16).substr(1);
    ...
    function w(t) {
        ...
        ("undefined" != typeof crypto && "function" == typeof crypto.getRandomValues ? crypto.getRandomValues(b) : "undefined" != typeof msCrypto && "function" == typeof msCrypto.getRandomValues ? msCrypto.getRandomValues(b) : b).substr(0, t)
    }
    function T(t, e, n) {
    ...
    function x() {
        return m && "function" == typeof Set && "function" == typeof JSON.stringify && y && "function" == typeof y.now && "withCredentials" in new window.XMLHttpRequest
    }
    function k(t, e, n) {
        if (n && t) {
            var r = F(t),
    ...
    function O(t, e, n) {
        for (var r = 0, i = e.length; r < i; ++r) {
            var a = e[r];
            if (L(a) || "function" == typeof a)
                for (var o = Object.keys(a), s = 0, c = o.length; s < c; s++) {
                    var u = o[s],
                    f = a[u];
                    n && L(f) ? (L(t[u]) || (t[u] = Array.isArray(f) ? [] : {}), O(t[u], [f], !1)) : t[u] = f
                }
        }
        return t
    }
    ...
    function I(t) {
        return O(t, g.call(arguments, 1), !1)
    }
    function j(t) {
        return O(t, g.call(arguments, 1), !0)
    }
    function R(t) {
        return void 0 === t
    }
    ...
    function H(t, e) {
        return R(e) || R(t) ? null : parseInt(e - t)
    }
    function U(t) {
        h.resolve().then(t)
    }
    function z() {
        return "function" == typeof y.getEntriesByType
    }
    function D(t) {
    ...
    var B = [["#", "hash"], ["?", "query"], ["/", "path"], ["@", "auth", 1], [NaN, "host", void 0, 1]],
    V = /^([a-z][a-z0-9.+-]*:)?(\/\/)?([\S\s]*)/i,
    $ = function () {
        function t(t) {
            var e,
                ...
                if ("string" == typeof d) {
                    if (~(e = i.indexOf(d))) {
                        ...
                        if (p) {
                            ...
                            this[l] = i.slice(e), i = i.slice(0, e)
                    }
                } else
                    this[l] = i, i = "";
    ...
    ();
    var J = "invoke",
    X = ["link", "css", "script", "img", "xmlhttprequest", "fetch", "beacon", "iframe"],
    G = "page-load",
    Z = [G, "route-change", "user-interaction", "http-request", "custom", "temporary"],
    Y = ["tags"];
    function Q(t) {
        var e = {
    ...
    function et(t, e) {
        ...
        a = {};
        if (t.type === G && z()) {
            var o = y.getEntriesByType("navigation");
            o && o.length > 0 && (a = {
                    response: Q(o[0])
                })
        }
    ...
    var ht = function () {
        ...
        var n = e.prototype;
        return n.createErrorDataModel = function (e) {
            var n = function (t) {
        ...
        n.logPromiseEvent = function (t) {
            var e,
            n = "Unhandled promise rejection: ",
            r = t.reason;
            (null == r && (r = "<no reason specified>"), "string" == typeof r.message) ? e = {
                error: r,
    ...
    yt = function () {
        ...
        e.addContext = function () {
            for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++)
                e[n] = arguments[n];
            0 !== e.length && (this.ensureContext(), j.apply(void 0, [this.context].concat(e)))
        },
        e.end = function (t) {
            this.ended || (this.ended = !0, this._end = M(t), this.callOnEnd())
        },
        e.callOnEnd = function () {
            "function" == typeof this.onEnd && this.onEnd(this)
        },
        e.duration = function () {
            return H(this._start, this._end)
        },
        t
    }
    ();
    ...
    wt = [["domainLookupStart", "domainLookupEnd", "Domain lookup"], ["connectStart", "connectEnd", "Making a connection to the server"], ["requestStart", "responseEnd", "Requesting and receiving the document"], ["domLoading", "domInteractive", "Parsing the document, executing sync. scripts"], ["domContentLoadedEventStart", "domContentLoadedEventEnd", 'Fire "DOMContentLoaded" event'], ["loadEventStart", "loadEventEnd", 'Fire "load" event']];
    ...
    var kt = ["fetchStart", "domainLookupStart", "domainLookupEnd", "connectStart", "connectEnd", "requestStart", "responseStart", "responseEnd", "domLoading", "domInteractive", "domContentLoadedEventStart", "domContentLoadedEventEnd", "domComplete", "loadEventStart", "loadEventEnd"],
    Ct = ["fs", "ls", "le", "cs", "ce", "qs", "rs", "re", "dl", "di", "ds", "de", "dc", "es", "ee"];
    function Lt(t) {
        var e = function (t) {
            var e = t.fetchStart,
            n = t.navigationStart,
    ...
    function Ot(t) {
        if (t.captureTimings) {
            ...
            if (t.type === G) {
                ...
                var r = y.timing;
                (function (t, e, n, r) {
                    for (var i = [], a = 0; a < wt.length; a++) {
                        var o = t[wt[a][0]],
                        s = t[wt[a][1]];
                        if (Tt(o, s, n, r, e)) {
                            var c = new _t(wt[a][2], "hard-navigation.browser-timing"),
                            u = null;
                            "requestStart" === wt[a][0] && (c.pageResponse = !0, u = {
                                    url: location.origin
                                }),
                            c._start = o - e,
                            c.end(s - e, u),
            ...
            if (z()) {
                ...
                (function (t, e, n, r) {
                    for (var i = [], a = 0; a < t.length; a++) {
                        ...
                        u = o.startTime,
                        f = o.responseEnd;
                        -1 !== X.indexOf(s) && null != c && (("xmlhttprequest" === s || "fetch" === s) && (/intake\/v\d+\/rum\/events/.test(c) || xt(u, e)) || Tt(u, f, n, r) && i.push(Et(t[a])))
                    }
                    return i
                })(y.getEntriesByType("resource"), bt.bootstrapTime, i, e).forEach((function (e) {
                ...
                (y.getEntriesByType("measure"), i, e).forEach((function (e) {
                        return t.spans.push(e)
                    }))
            }
        }
    ...
    function jt(t) {
        ...
        var e = function (t) {
            if (!t)
                return null;
            var e = {};
            return Ct.forEach((function (n, r) {
                    var i = kt[r];
                    e[n] = t[i]
                })),
            e
    ...
    function qt(t, e) {
        ...
        return new h((function (r) {
                ...
                if (function () {
                    ...
                    if (null != sessionStorage.getItem(t))
                        return !0;
                    if (!window.URL || !window.URLSearchParams)
                        return !1;
                    try {
                        var e = new URL(window.location.href).searchParams.has(t);
                        return e && sessionStorage.setItem(t, !0),
                        e
                    } catch (t) {}
                    return !1
                }
    ...
    function Jt(t, e, n) {
        ...
        return new h((function (n, r) {
                ...
                if (u[Dt] = !0, u.open(t, e, !0), u.timeout = i, u.withCredentials = c, o)
                    for (var f in o)
                        o.hasOwnProperty(f) && u.setRequestHeader(f, o[f]);
    ...
    var Xt = function () {
        ...
        e._makeHttpRequest = function (t, e, n) {
            ...
            return !c && Pt(t, o) ? function (t, e, n) {
                var r,
                i = n.keepalive,
                a = void 0 !== i && i,
                o = n.timeout,
        ...
        e.fetchConfig = function (t, e) {
            ...
            if (!t)
                return h.reject("serviceName is required for fetching central config.");
            r += "?service.name=" + t,
            ...
            return this._makeHttpRequest("GET", r, {
                ...
                beforeSend: a
                    ...
                    return o && (a.etag = o.replace(/["]/g, ""), n._configService.setLocalConfig(a, !0)),
                    a
                })).catch((function (t) {
        ...
        e.ndjsonTransactions = function (t, e) {
            ...
            return t.map((function (t) {
                    ...
                    return e || (t.spans && (a = t.spans.map((function (t) {
                                    ...
                                    })).join(""), delete t.spans), t.breakdown && (o = n.ndjsonMetricsets(t.breakdown), delete t.breakdown)),
                    mt.stringify(((i = {})[r] = e ? function (t) {
                            var e,
    ...
    Gt = function () {
        ...
        return e.observe = function (t, e) {
            ...
            if ("function" == typeof e)
                return this.observers[t] || (this.observers[t] = []), this.observers[t].push(e), function () {
    ...
    Qt = function () {
        ...
        e.setConfig = function (t) {
            ...
            R(n) || (n < 1e-4 && n > 0 && (n = 1e-4), t.transactionSampleRate = Math.round(1e4 * n) / 1e4),
            j(this.config, t),
    ...
    function ee(t) {
        ...
        if (e && e.addEventListener)
            var n = zt(e, "open", (function () {
                        return function (t, e) {
                            return t[Dt] || (t[$t] = e[0], t[Vt] = e[1], t[Bt] = !1 === e[2]),
                            n.apply(t, e)
                        }
                    })), r = zt(e, "send", (function () {
                        return function (e, n) {
                            if (e[Dt])
                                return r.apply(e, n);
                            var a = {
        ...
        function i(e, n) {
            e.state !== J && (e.state = J, e.data.status = n, t(J, e))
        }
    }
    var ne = new Gt,
    re = !1;
    function ie() {
        return re || (re = !0, ee((function (t, e) {
                    ne.send("xmlhttprequest", [t, e])
                })), function (t) {
            if (Mt()) {
                var e = window.fetch;
    ...
    var ae = function () {
        ...
        return e.init = function (t) {
            ...
            t.history && ne.observe("history", this.getHistorySub()),
            t.xmlhttprequest && ne.observe("xmlhttprequest", this.getXHRSub()),
            t.fetch && ne.observe("fetch", this.getFetchSub())
        },
        e.getHistorySub = function () {
            var t = this._transactionService;
            return function (e, n) {
                "history" === n.source && e === J && t.startTransaction(n.data.title, "route-change", {
                    managed: !0,
                    canReuse: !0
                })
            }
        ...
        e.getXHRSub = function () {
            var t = this;
            return function (e, n) {
                "xmlhttprequest" !== n.source || Ht.fetchInProgress || t.processAPICalls(e, n)
            }
        },
        ...
        e.processAPICalls = function (t, e) {
            ...
            if ("schedule" === t && e.data) {
                var a = e.data,
                o = new $(a.url),
                s = a.method + " " + (o.relative ? o.path : C(o.href));
                r.getCurrentTransaction() || r.startTransaction(s, "http-request", {
                    managed: !0
                });
                var c = r.startSpan(s, "external.http", {
                    blocking: !0
                });
                if (!c)
                    return;
                ...
                d = new $(window.location.href),
                l = E(o.origin, d.origin) || E(o.origin, f),
                p = a.target;
                if (u && l && p)
                    this.injectDtHeader(c, p), n.get("propagateTracestate") && this.injectTSHeader(c, p);
                else
                    0;
        ...
        e.injectDtHeader = function (t, e) {
            ...
            (t);
            /^[\da-f]{2}-[\da-f]{32}-[\da-f]{16}-[\da-f]{2}$/.test(n = i) && "00000000000000000000000000000000" !== n.slice(3, 35) && "0000000000000000" !== n.slice(36, 52) && i && r && T(e, r, i)
        },
    ...
    (),
    oe = [["domainLookupStart", "domainLookupEnd", "DNS"], ["connectStart", "connectEnd", "TCP"], ["requestStart", "responseStart", "Request"], ["responseStart", "responseEnd", "Response"], ["domLoading", "domComplete", "Processing"], ["loadEventStart", "loadEventEnd", "Load"]];
    function se(t) {
        return {
            value: t
        }
    ...
    function ce(t, e) {
        ...
        return {
            ...
            span: n,
            samples: {
                "span.self_time.count": se(i),
                "span.self_time.sum.us": se(a)
            }
        }
    }
    function ue(t, e) {
    ...
    var fe = function (t) {
        ...
        function r(e, n, r) {
            var i;
            return (i = t.call(this, e, n, r) || this).traceId = w(),
            i.marks = void 0,
            i.spans = [],
            i._activeSpans = {},
        ...
        i.redefine = function (t, e, n) {
            t && (this.name = t),
            e && (this.type = e),
            n && (this.options.reuseThreshold = n.reuseThreshold, I(this.options, n))
        },
        ...
        i.end = function (t) {
            if (!this.ended) {
                for (var e in this.ended = !0, this._end = M(t), this._activeSpans) {
        ...
        i.captureBreakdown = function () {
            this.breakdownTimings = function (t, e) {
                ...
                if (n.push({
                        transaction: s,
                        samples: {
                            "transaction.duration.count": se(1),
                            "transaction.duration.sum.us": se(r),
                            "transaction.breakdown.count": se(o ? 1 : 0)
                        }
                    }), !o)
                    return n;
                if (a === G && e)
    ...
    function le(t, e) {
        ...
        if (d) {
            ...
            de.fcp = l,
            a.marks.firstContentfulPaint = l
        }
        var p = function (t) {
            var e = t[0];
            if (e) {
                var n = e.startTime,
                r = e.processingStart,
                i = new _t("First Input Delay", "first-input", {
                    startTime: n
                });
                return i.end(r),
                i
        ...
        return p && (de.fid = p.duration(), a.spans.push(p)),
        function (t) {
    ...
    ve = function () {
        ...
        e.startManagedTransaction = function (t, e, n) {
            ...
            if (r)
                if (r.canReuse() && n.canReuse) {
                    ...
                    r.end(), r = this.createCurrentTransaction(t, e, n);
            else
                r = this.createCurrentTransaction(t, e, n);
            return r.type === G && (i || (this.recorder.start("largest-contentful-paint"), this.recorder.start("paint"), this.recorder.start("first-input"), this.recorder.start("layout-shift")), n.pageLoadTraceId && (r.traceId = n.pageLoadTraceId), n.pageLoadSampled && (r.sampled = n.pageLoadSampled), "Unknown" === r.name && n.pageLoadTransactionName && (r.name = n.pageLoadTransactionName)),
        ...
        e.startTransaction = function (t, e, n) {
            ...
            o = !0;
            a.managed ? this.currentTransaction === (r = this.startManagedTransaction(t, e, a)) && (o = !1) : r = new fe(t, e, a);
        ...
        e.handleTransactionEnd = function (t) {
            ...
            return h.resolve().then((function () {
                    var r = t.name,
                    i = t.type;
                    if (!(bt.lastHiddenStart >= t._start || e.shouldIgnoreTransaction(r) || "temporary" === i)) {
                        if (i === G) {
                            ...
                            if ("Unknown" === r && a && (t.name = a), t.captureTimings) {
                                ...
                                c = de.tbt,
                                u = de.longtask;
                                c.duration > 0 && t.spans.push((d = (f = c).start, l = f.duration, (p = new _t("Total Blocking Time", "longtask", {
                                                startTime: d
                                            })).end(d + l), p)),
                                t.experience = {},
                                D("longtask") && (t.experience.tbt = c.duration),
                                D("layout-shift") && (t.experience.cls = o.score),
                        ...
                        "Unknown" === t.name && (t.name = function (t, e) {
                            void 0 === e && (e = 2);
                            for (var n = new $(t), r = n.query, i = n.path.substring(1).split("/"), a = /\W|_/g, o = /[0-9]/g, s = /[a-z]/g, c = /[A-Z]/g, u = [], f = !1, d = 0; d < i.length; d++) {
                                var l = i[d];
                                if (f || d > e - 1) {
                                    l && u.push("*");
                                    break
                                ...
                                if ((l.match(a) || []).length >= 2)
                                    ...
                                    if (p > 3 || l.length > 3 && p / l.length >= .3)
                                        u.push(":id"), f = !0;
                                    else {
    ...
    var ge = !1;
    function me() {
        return x() ? (ie(), bt.bootstrapTime = P(), ge = !0) : m && console.log("[Elastic APM] platform is not supported!"),
        ge
    }
    function ye(t, e) {
        var n = e.getCurrentTransaction();
        if (n) {
            var r = t.observeEvent("queue:add_transaction", (function () {
                        t.dispatchEvent("queue:flush"),
                        bt.lastHiddenStart = P(),
                        r()
                    }));
            n.end()
        } else
            t.dispatchEvent("queue:flush"), bt.lastHiddenStart = P()
    }
    function Se(t) {
        var e = function (e) {
            e.target instanceof Element && function (t, e) {
                var n = function (t) {
                    ...
                    r = n;
                    if (t.dataset.transactionName)
                        r = t.dataset.transactionName;
                    else {
        ...
        e.init = function (t) {
            ...
            if (this.isEnabled() && !this._initialized) {
                ...
                if (i.setLevel(o), r.get("active")) {
                    ...
                    var s = function (t, e) {
                        var n,
                        r = ((n = {}).xmlhttprequest = !1, n.fetch = !1, n.history = !1, n[G] = !1, n.error = !1, n.eventtarget = !1, n.click = !1, n);
                    ...
                    if (r.get("session")) {
                        ...
                        c && c.session && r.setConfig({
                            session: c.session
                        })
                    }
                    var u = function () {
                        return s[G] && e._sendPageLoadMetrics()
                    };
                    r.get("centralConfig") ? this.fetchCentralConfig().then(u) : u(),
                    function (t, e) {
                        "hidden" === document.visibilityState && (bt.lastHiddenStart = 0);
                        var n = function () {
                            "hidden" === document.visibilityState && ye(t, e)
                        },
                        r = function () {
                            return ye(t, e)
                        };
                    ...
                    (r, a),
                    s.eventtarget && s.click && Se(a)
                } else
                    this._disable = !0, i.warn("RUM agent is inactive")
            }
            return this
        },
    ...
    ();
    var be = function () {
        if (m && window.elasticApm)
            return window.elasticApm;
        var t = me(),
        e = he(),
        n = new _e(e, !t);
        return m && (window.elasticApm = n),
        n
    }
    ();
    be.init.bind(be)
